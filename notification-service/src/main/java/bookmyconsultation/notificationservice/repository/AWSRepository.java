...
public class AWSRepository {
    ...
    public void sendDoctorUpdateEmail(Map<String, String> parseMap)
    ...
    public void sendAppointmentConfirmationEmail(Map<String, String> parseMap)
            throws IOException, TemplateException, MessagingException, javax.mail.MessagingException {
        Map<String, Object> templateModel = new HashMap<>();
    ...
    public void sendPrescriptionEmail(Map<String, String> parseMap)
            throws IOException, TemplateException, MessagingException, javax.mail.MessagingException {
        Map<String, Object> templateModel = new HashMap<>();
