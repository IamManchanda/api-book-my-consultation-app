...
public class AWSRepository {
    ...
    private String BUCKET_NAME = "bmc.doctors.bucket";
    private String ACCESS_KEY = "AKIAY3VWTB6GQAYUW2D6";
    private String ACCESS_SECRET = "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";
    private String SMTP_ACCESS_KEY = "AKIAY3VWTB6GUAG642Z4";
    private String SMTP_ACCESS_SECRET = "BKBBQMuPJDOkBCvh9La9CCjXhX28J7+5ZfoX48jG78jH";
    private AmazonS3 s3Client;
    private SesClient sesClient;
    private final FreeMarkerConfigurer freeMarkerConfig;
    private String FROM_EMAIL = "harry@kibanu.com";
    ...
    public ByteArrayOutputStream downloadFile(String doctorId, String fileName) {
        String key = doctorId + "/" + fileName;
        try {
    ...
    public List<String> listFiles(String doctorId) {
        ...
        while (true) {
            ...
            for (S3ObjectSummary item : objectSummaries) {
                if (!item.getKey().endsWith("/") && item.getKey().startsWith(doctorId))
    ...
    public void sendEmail(DoctorDTO doctor)
    ...
    public void sendVerificationEmail(DetailDoctorDTO doctor)
            throws IOException, TemplateException, MessagingException, javax.mail.MessagingException {
        Map<String, Object> templateModel = new HashMap<>();
        templateModel.put("user", doctor);
